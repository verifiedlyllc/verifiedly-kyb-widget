        ...
        <div class="">
          <form action="" class="row">
            ...
            <div class="col-12 d-md-flex justify-content-end margin-t-2">
              ...
              <a class=" business_btn  btn btn_lg_primary padding-px-6 padding-py-2  bg-blue rounded-12 c-white">
                  Get Started
              </a>
            </div>
          </form>
        ...
        <div class="form_cc_four">
            <form action="" class="row">
              ...
              <div class="col-12 d-md-flex justify-content-end margin-t-2">
                ...
                <a href="verification.html" class="btn btn_lg_primary  padding-px-6 padding-py-2  bg-blue rounded-12 c-white h-fit-content">
                    Next
                </a>
              </div>
            </form>
...
<head>
  ...
  <link href="https://res.cloudinary.com/verifiedly/raw/upload/v1625605460/css/bootstrap-datetimepicker.min_jy5hfa.css" rel="stylesheet" />
...
<body class="bg-white d-flex flex flex-column justify-content-center align-item-center">
  ...
  <div class="row d-flex justify-content-center align-item-center">
            ...
            <form action="" class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input id="email" type="email" class="form-control" placeholder="alma.lawson@example.com">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="number">Phone Number</label>
                  <input id="number" autocomplete="tel" type="number" class="form-control" placeholder="">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="date">Incorporated Date</label>
                  <div class='input-group position-relative'>
                    <input class="datepicker form-control" id="date" type="text" placeholder="12-02-2012"/>
            
                 <i class="tio calendar font-s-24 calender_icon "></i>
            </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label for="ein" class="type_name"></label>
                  <input id="ein" type="number" class="form-control" placeholder="0701 384 7560">
                </div>
              </div>
              <div class="col-12 d-flex d-md-flex justify-content-between ">
          
                <a class="btn btn_lg_primary back_to_business_btn padding-px-6 padding-py-2  bg-snow c-black rounded-12 c-white h-fit-content">
                    Back
                </a>
                <a  class="btn btn_lg_primary finish_btn padding-px-6 padding-py-2  bg-blue rounded-12 c-white h-fit-content">
                    Finish
                </a>
              </div>
            </form>
    ...
    <div class="row">
      <div class="col-12 text-center mx-auto margin-t-1">
        Powered by verifiedly <img src="https://res.cloudinary.com/verifiedly/image/upload/v1624041053/verifiedly_logo_ppus4g.svg" class="img_logo" alt="verifiedly logo">
    </div>
    </div>
    <div class="footer padding-py-2 padding-px-2"></div>
  ...
  <script src="https://res.cloudinary.com/verifiedly/raw/upload/v1625605453/js/datepicker_b5e0yx.js"></script>
  <script src="https://res.cloudinary.com/verifiedly/raw/upload/v1625605455/js/moment-with-locales.min_xzeoon.js"></script>
